...
public class CodeProportionsComputerJob extends Job {
    ...
    public static final String codeProportionsComputerJob_computing = "Computing code proportions for Java files"; //$NON-NLS-1$
    public static final String codeProportionsComputerJob_name = "Code proportions computer"; //$NON-NLS-1$
