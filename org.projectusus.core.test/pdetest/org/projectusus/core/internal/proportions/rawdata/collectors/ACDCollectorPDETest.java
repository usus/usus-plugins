...
public class ACDCollectorPDETest extends PDETestForMetricsComputation {
    ...
    public void singleClass() throws Exception {
        ...
        assertEquals( 1, getModel().getAllClassRepresenters().size() );
    ...
    public void twoUnrelatedClasses() throws Exception {
        ...
        assertEquals( 2, getModel().getAllClassRepresenters().size() );
    ...
    public void threeUnrelatedClasses() throws Exception {
        ...
        assertEquals( 3, getModel().getNumberOf( CodeProportionUnit.CLASS ) );
        assertEquals( 3, getModel().getAllClassRepresenters().size() );
    ...
    public void tenRelatedClasses1knows2() throws Exception {
        ...
        assertEquals( 10, getModel().getNumberOf( CodeProportionUnit.CLASS ) );
        assertEquals( 10, getModel().getAllClassRepresenters().size() );
